...
export class ChoresComponent implements OnInit {
  /* chores = ['Empty dishwasher', 'Complete LaunchCode prep work', 'Buy groceries','Clean bathrooms'];
   todoTitles = ["Yesterday's Chores", "Today's Chores", "Tomorrow's Chores","10 Days Latter Chores"];*/
   chores = [
